...
# Methods Used
-->Export Coefficient Model (ECM) applied to estimate TN and TP loads.  
-->Linear programming model used for effective land-use planning.  
-->Multi-objective optimization for balancing economic return and pollution reduction.  
